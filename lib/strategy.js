...
var host = process.env.PASSPORT_COMMON_HOST || 'http://127.0.0.1:3002';
...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || host + '/oauth/authorize';
  options.tokenURL = options.tokenURL || host + '/oauth/token';
  ...
  this.name = 'common';
  this.provider = options.provider || 'common';
  this._userProfileURL = options.userProfileURL || host + '/api/user/detail';
